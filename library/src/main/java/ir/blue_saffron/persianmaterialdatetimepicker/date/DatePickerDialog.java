...
package ir.blue_saffron.persianmaterialdatetimepicker.date;
...
import ir.blue_saffron.persianmaterialdatetimepicker.HapticFeedbackController;
import ir.blue_saffron.persianmaterialdatetimepicker.R;
import ir.blue_saffron.persianmaterialdatetimepicker.Utils;
...
//        okButton.setTypeface(TypefaceHelper.get(activity,"Roboto-Medium")); //TODO: Changed Here.
...
//        cancelButton.setTypeface(TypefaceHelper.get(activity,"Roboto-Medium")); //TODO: Changed Here.
    ...
    private void setCurrentView(final int viewIndex) {
        ...
        switch (viewIndex) {
            case MONTH_AND_DAY_VIEW:
                ...
                String dayString = mPersianCalendar.getPersianLongDate();
            ...
            case YEAR_VIEW:
                ...
                String yearString = String.valueOf(mPersianCalendar.getPersianYear());
    ...
    private void updateDisplay(boolean announce) {
        ...
        mSelectedDayTextView.setText(String.valueOf(mPersianCalendar.getPersianDay()));
        mYearView.setText(String.valueOf(mPersianCalendar.getPersianYear()));

        // Accessibility.
        long millis = mPersianCalendar.getTimeInMillis();
        mAnimator.setDateMillis(millis);
        String monthAndDayText = mPersianCalendar.getPersianMonthName() + " " + mPersianCalendar.getPersianDay();
        mMonthAndDayView.setContentDescription(monthAndDayText);

        if (announce) {
            String fullDateText = mPersianCalendar.getPersianLongDate();
